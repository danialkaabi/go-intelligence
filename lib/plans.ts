...
export const PLANS: Plan[] = [
  {
    ...
    features: ['Fleet', 'Companies', 'Contracts', 'Tenders', 'Maps', 'Market', 'AI', 'Alerts', 'App'],
  ...
  },
  {
    ...
    features: ['Fleet', 'Companies', 'Contracts', 'Tenders', 'Maps', 'Market', 'AI', 'Alerts', 'Excel export', 'App'],
  ...
  },
  {
    ...
    features: ['Fleet', 'Companies', 'Contracts', 'Tenders', 'Maps', 'Market', 'AI', 'Alerts', 'API', 'Excel export', 'App'],
